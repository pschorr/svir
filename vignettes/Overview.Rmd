...
1. Pre-Assignment 6 Accomplishments
    a. Access ATSDR SVI nation wide variable data. (https://svi.cdc.gov/SVIDataToolsDownload.html)
    b. Review SVI documentation, 2011 Department of Homeland Security and Emergency Management study and post-hoc index application to Hurricane Katrina case study. (https://gis.cdc.gov/grasp/svi/A%20Social%20Vulnerability%20Index%20for%20Disaster%20Management.pdf)
    c. 
